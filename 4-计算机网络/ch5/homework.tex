...
%Flowchart: Process [id:dp6476710939616235] 
\draw   (131.45,65.05) -- (612.45,65.05) -- (612.45,83.59) -- (131.45,83.59) -- cycle ;
%Flowchart: Process [id:dp5684743885631083] 
\draw  [fill={rgb, 255:red, 248; green, 231; blue, 28 }  ,fill opacity=1 ] (131.45,65.05) -- (223.45,65.05) -- (223.45,83.59) -- (131.45,83.59) -- cycle ;
%Flowchart: Process [id:dp6826693646429127] 
\draw  [fill={rgb, 255:red, 80; green, 227; blue, 194 }  ,fill opacity=1 ] (223.45,65.05) -- (315.45,65.05) -- (315.45,83.59) -- (223.45,83.59) -- cycle ;
%Straight Lines [id:da16985463954449176] 
\draw    (131.5,45.28) -- (131.46,63.05) ;
\draw [shift={(131.45,65.05)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da05915821453522385] 
\draw    (223.5,45.28) -- (223.46,63.05) ;
\draw [shift={(223.45,65.05)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da9292914040396496] 
\draw    (315.5,45.28) -- (315.46,63.05) ;
\draw [shift={(315.45,65.05)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Flowchart: Process [id:dp9119068885136326] 
\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (223.45,65.05) -- (229.45,65.05) -- (229.45,83.59) -- (223.45,83.59) -- cycle ;
%Straight Lines [id:da47345640549089785] 
\draw    (229.5,45.28) -- (229.46,63.05) ;
\draw [shift={(229.45,65.05)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Flowchart: Process [id:dp6455994172850834] 
\draw   (130.93,130.28) -- (611.93,130.28) -- (611.93,148.83) -- (130.93,148.83) -- cycle ;
%Flowchart: Process [id:dp16120342062012205] 
\draw  [fill={rgb, 255:red, 248; green, 231; blue, 28 }  ,fill opacity=1 ] (130.45,130.28) -- (315.5,130.28) -- (315.5,148.83) -- (130.45,148.83) -- cycle ;
%Straight Lines [id:da5794255411111329] 
\draw    (130.98,110.51) -- (130.94,128.28) ;
\draw [shift={(130.93,130.28)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da7322761143158161] 
\draw    (314.98,110.51) -- (314.94,128.28) ;
\draw [shift={(314.93,130.28)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Flowchart: Process [id:dp9341011208523518] 
\draw   (130.45,192.77) -- (611.45,192.77) -- (611.45,211.32) -- (130.45,211.32) -- cycle ;
%Flowchart: Process [id:dp07307771122944295] 
\draw  [fill={rgb, 255:red, 248; green, 231; blue, 28 }  ,fill opacity=1 ] (212.45,192.77) -- (314.45,192.77) -- (314.45,211.32) -- (212.45,211.32) -- cycle ;
%Flowchart: Process [id:dp7707215812297679] 
\draw  [fill={rgb, 255:red, 80; green, 227; blue, 194 }  ,fill opacity=1 ] (314.45,192.77) -- (406.45,192.77) -- (406.45,211.32) -- (314.45,211.32) -- cycle ;
%Straight Lines [id:da6912331680325958] 
\draw    (212.5,173) -- (212.46,190.77) ;
\draw [shift={(212.45,192.77)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da14405047375548818] 
\draw    (314.5,173) -- (314.46,190.77) ;
\draw [shift={(314.45,192.77)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Flowchart: Process [id:dp09152060908941984] 
\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (314.45,192.77) -- (320.45,192.77) -- (320.45,211.32) -- (314.45,211.32) -- cycle ;
%Straight Lines [id:da0704783338611159] 
\draw    (320.5,173) -- (320.46,190.77) ;
\draw [shift={(320.45,192.77)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da8430430406909915] 
\draw    (406.5,173) -- (406.46,190.77) ;
\draw [shift={(406.45,192.77)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Flowchart: Process [id:dp5132545881959998] 
\draw   (129.45,260.9) -- (610.45,260.9) -- (610.45,279.44) -- (129.45,279.44) -- cycle ;
%Flowchart: Process [id:dp7026822667509893] 
\draw  [fill={rgb, 255:red, 248; green, 231; blue, 28 }  ,fill opacity=1 ] (211.45,260.9) -- (357.45,260.9) -- (357.45,279.44) -- (211.45,279.44) -- cycle ;
%Flowchart: Process [id:dp9205038375810153] 
\draw  [fill={rgb, 255:red, 80; green, 227; blue, 194 }  ,fill opacity=1 ] (360.45,260.9) -- (405.45,260.9) -- (405.45,279.44) -- (360.45,279.44) -- cycle ;
%Straight Lines [id:da0146434735422587] 
\draw    (211.5,241.12) -- (211.46,258.9) ;
\draw [shift={(211.45,260.9)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da9765693033578569] 
\draw    (363.5,241.12) -- (363.46,258.9) ;
\draw [shift={(363.45,260.9)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Flowchart: Process [id:dp7418388446504094] 
\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (357.45,260.9) -- (363.45,260.9) -- (363.45,279.44) -- (357.45,279.44) -- cycle ;
%Straight Lines [id:da5894472380449884] 
\draw    (357.5,241.12) -- (357.46,258.9) ;
\draw [shift={(357.45,260.9)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da3149282315572639] 
\draw    (405.5,241.12) -- (405.46,258.9) ;
\draw [shift={(405.45,260.9)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Flowchart: Process [id:dp30625562437549214] 
\draw   (130.45,335.4) -- (611.45,335.4) -- (611.45,353.95) -- (130.45,353.95) -- cycle ;
%Flowchart: Process [id:dp0930548219415035] 
\draw  [fill={rgb, 255:red, 248; green, 231; blue, 28 }  ,fill opacity=1 ] (212.45,335.4) -- (358.45,335.4) -- (358.45,353.95) -- (212.45,353.95) -- cycle ;
%Flowchart: Process [id:dp9694187201663134] 
\draw  [fill={rgb, 255:red, 80; green, 227; blue, 194 }  ,fill opacity=1 ] (361.45,335.4) -- (406.45,335.4) -- (406.45,353.95) -- (361.45,353.95) -- cycle ;
%Straight Lines [id:da6743443325831382] 
\draw    (212.5,315.63) -- (212.46,333.4) ;
\draw [shift={(212.45,335.4)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da07714405991574669] 
\draw    (364.5,315.63) -- (364.46,333.4) ;
\draw [shift={(364.45,335.4)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Flowchart: Process [id:dp5548238982861298] 
\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (358.45,335.4) -- (364.45,335.4) -- (364.45,353.95) -- (358.45,353.95) -- cycle ;
%Straight Lines [id:da48352848295972595] 
\draw    (358.5,315.63) -- (358.46,333.4) ;
\draw [shift={(358.45,335.4)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da09816431108859924] 
\draw    (406.5,315.63) -- (406.46,333.4) ;
\draw [shift={(406.45,335.4)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Flowchart: Process [id:dp1208309916518655] 
\draw   (130.45,414.88) -- (611.45,414.88) -- (611.45,433.42) -- (130.45,433.42) -- cycle ;
%Flowchart: Process [id:dp36191568625575554] 
\draw  [fill={rgb, 255:red, 248; green, 231; blue, 28 }  ,fill opacity=1 ] (303.45,414.88) -- (358.45,414.88) -- (358.45,433.42) -- (303.45,433.42) -- cycle ;
%Flowchart: Process [id:dp9273005347567278] 
\draw  [fill={rgb, 255:red, 80; green, 227; blue, 194 }  ,fill opacity=1 ] (361.45,414.88) -- (523.45,414.88) -- (523.45,433.42) -- (361.45,433.42) -- cycle ;
%Straight Lines [id:da005899034571152484] 
\draw    (303.5,395.11) -- (303.46,412.88) ;
\draw [shift={(303.45,414.88)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da04140244725595821] 
\draw    (364.5,395.11) -- (364.46,412.88) ;
\draw [shift={(364.45,414.88)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Flowchart: Process [id:dp007657056176108679] 
\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (358.45,414.88) -- (364.45,414.88) -- (364.45,433.42) -- (358.45,433.42) -- cycle ;
%Straight Lines [id:da5208491749268904] 
\draw    (358.5,395.11) -- (358.46,412.88) ;
\draw [shift={(358.45,414.88)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da7832011342326544] 
\draw    (523.5,395.11) -- (523.46,412.88) ;
\draw [shift={(523.45,414.88)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Flowchart: Process [id:dp2913515085587821] 
\draw   (129.45,494.35) -- (610.45,494.35) -- (610.45,512.9) -- (129.45,512.9) -- cycle ;
%Flowchart: Process [id:dp44262192690841906] 
\draw  [fill={rgb, 255:red, 248; green, 231; blue, 28 }  ,fill opacity=1 ] (302.45,494.35) -- (444.45,494.35) -- (444.45,512.9) -- (302.45,512.9) -- cycle ;
%Flowchart: Process [id:dp9730276776279176] 
\draw  [fill={rgb, 255:red, 80; green, 227; blue, 194 }  ,fill opacity=1 ] (450.45,494.35) -- (522.45,494.35) -- (522.45,512.9) -- (450.45,512.9) -- cycle ;
%Straight Lines [id:da20511111469671484] 
\draw    (302.5,474.58) -- (302.46,492.35) ;
\draw [shift={(302.45,494.35)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da07281313800553946] 
\draw    (450.5,474.58) -- (450.46,492.35) ;
\draw [shift={(450.45,494.35)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Flowchart: Process [id:dp7660329203270071] 
\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (444.45,494.35) -- (450.45,494.35) -- (450.45,512.9) -- (444.45,512.9) -- cycle ;
%Straight Lines [id:da8461834258165128] 
\draw    (444.5,474.58) -- (444.46,492.35) ;
\draw [shift={(444.45,494.35)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da47817425752225073] 
\draw    (522.5,474.58) -- (522.46,492.35) ;
\draw [shift={(522.45,494.35)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Flowchart: Process [id:dp029391241589284967] 
\draw   (128.45,559.64) -- (609.45,559.64) -- (609.45,578.18) -- (128.45,578.18) -- cycle ;
%Flowchart: Process [id:dp11211392206843018] 
\draw  [fill={rgb, 255:red, 80; green, 227; blue, 194 }  ,fill opacity=1 ] (449.45,559.64) -- (583.45,559.64) -- (583.45,578.18) -- (449.45,578.18) -- cycle ;
%Straight Lines [id:da4432150211254484] 
\draw    (449.5,539.86) -- (449.46,557.64) ;
\draw [shift={(449.45,559.64)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da7187155569583683] 
\draw    (583.5,539.86) -- (583.46,557.64) ;
\draw [shift={(583.45,559.64)}, rotate = 270.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;

% Text Node
\draw (130.52,36) node   [align=left] {\begin{minipage}[lt]{8.67pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 0}
\end{minipage}};
% Text Node
\draw (206.52,36) node   [align=left] {\begin{minipage}[lt]{23.09pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 1023}
\end{minipage}};
% Text Node
\draw (243.5,36) node   [align=left] {\begin{minipage}[lt]{27.2pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 1024}
\end{minipage}};
% Text Node
\draw (316.95,36.71) node   [align=left] {\begin{minipage}[lt]{29.24pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 2047}
\end{minipage}};
% Text Node
\draw (130,101.24) node   [align=left] {\begin{minipage}[lt]{8.67pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 0}
\end{minipage}};
% Text Node
\draw (316.43,101.95) node   [align=left] {\begin{minipage}[lt]{29.24pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 2047}
\end{minipage}};
% Text Node
\draw (205.52,163.73) node   [align=left] {\begin{minipage}[lt]{23.09pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 1001}
\end{minipage}};
% Text Node
\draw (302.98,163.73) node   [align=left] {\begin{minipage}[lt]{23.83pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 2047}
\end{minipage}};
% Text Node
\draw (342,163.73) node   [align=left] {\begin{minipage}[lt]{29.24pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 2048}
\end{minipage}};
% Text Node
\draw (398.98,163.73) node   [align=left] {\begin{minipage}[lt]{11.59pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 3048}
\end{minipage}};
% Text Node
\draw (204.52,231.85) node   [align=left] {\begin{minipage}[lt]{23.09pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 1001}
\end{minipage}};
% Text Node
\draw (339.98,231.85) node   [align=left] {\begin{minipage}[lt]{23.83pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 2897}
\end{minipage}};
% Text Node
\draw (379,231.85) node   [align=left] {\begin{minipage}[lt]{29.24pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 2898}
\end{minipage}};
% Text Node
\draw (414.45,231.85) node   [align=left] {\begin{minipage}[lt]{16.32pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 3048}
\end{minipage}};
% Text Node
\draw (205.52,306.36) node   [align=left] {\begin{minipage}[lt]{23.09pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 1001}
\end{minipage}};
% Text Node
\draw (340.98,306.36) node   [align=left] {\begin{minipage}[lt]{23.83pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 2897}
\end{minipage}};
% Text Node
\draw (380,306.36) node   [align=left] {\begin{minipage}[lt]{29.24pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 2898}
\end{minipage}};
% Text Node
\draw (415.45,306.36) node   [align=left] {\begin{minipage}[lt]{16.32pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 3048}
\end{minipage}};
% Text Node
\draw (286.52,385.83) node   [align=left] {\begin{minipage}[lt]{23.09pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 2048}
\end{minipage}};
% Text Node
\draw (340.98,385.83) node   [align=left] {\begin{minipage}[lt]{23.83pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 2897}
\end{minipage}};
% Text Node
\draw (380,385.83) node   [align=left] {\begin{minipage}[lt]{29.24pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 2898}
\end{minipage}};
% Text Node
\draw (514.52,385.83) node   [align=left] {\begin{minipage}[lt]{12.21pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 4095}
\end{minipage}};
% Text Node
\draw (285.52,465.31) node   [align=left] {\begin{minipage}[lt]{23.09pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 2048}
\end{minipage}};
% Text Node
\draw (430.98,464.6) node   [align=left] {\begin{minipage}[lt]{23.83pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 3071}
\end{minipage}};
% Text Node
\draw (470,464.6) node   [align=left] {\begin{minipage}[lt]{29.24pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 3072}
\end{minipage}};
% Text Node
\draw (510.5,465.31) node   [align=left] {\begin{minipage}[lt]{16.32pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 4095}
\end{minipage}};
% Text Node
\draw (440.98,530.59) node   [align=left] {\begin{minipage}[lt]{11.59pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 3072}
\end{minipage}};
% Text Node
\draw (571.5,530.59) node   [align=left] {\begin{minipage}[lt]{16.32pt}\setlength\topsep{0pt}
{\fontfamily{ptm}\selectfont 5119}
\end{minipage}};
...
从上到下的八个长条图依次是第（1）小问到第（8）小问的回答。其中黄色是已用窗口（已发送未收到确认），青色为可用窗口
（未发送），其余部分（白色部分）为不可用窗口。

\answer[5-68]
没有问题。因为第三次握手中，是对连接的建立进行再一次的确认，自此就可以建立可靠的TCP连接。
